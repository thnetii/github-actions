...
/**
 * @typedef {typeof exportedFunctions} ExportedGhActionCoreHelperFunctions
 */

/**
 * @this {import("@actions/core")}
 * @returns {import("@actions/core") & {
 *  [N in keyof ExportedGhActionCoreHelperFunctions]: OmitThisParameter<ExportedGhActionCoreHelperFunctions[N]>
 * }}
 */
...
module.exports = {
   ...
   * @returns {ReturnType<withCoreHelpers>}
   */
